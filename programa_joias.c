...
static void inserirJoiaOrdenada(const char *dados_path, const char *del_path, const char *idx_path) {
    ...
    printf("Inserido com registro_id = %u\n", prox_id);
}
